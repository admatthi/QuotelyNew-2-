        ...
        self.present(activityViewController, animated: true, completion: nil)
          ...
          override func viewDidLoad() {
            ...
            backgroundimages.removeAll()
                       backgroundimages.append(UIImage(named: "couple1")!)
                       backgroundimages.append(UIImage(named: "couple2")!)
                       backgroundimages.append(UIImage(named: "couple3")!)
                       backgroundimages.append(UIImage(named: "couple4")!)
                         backgroundimages.append(UIImage(named: "couple5")!)
                         backgroundimages.append(UIImage(named: "couple6")!)
                       backgroundimages.append(UIImage(named: "couple7")!)
                         backgroundimages.append(UIImage(named: "couple8")!)
                         backgroundimages.append(UIImage(named: "couple9")!)
                       backgroundimages.append(UIImage(named: "couple10")!)
                         backgroundimages.append(UIImage(named: "couple11")!)
                         backgroundimages.append(UIImage(named: "couple12")!)
